...
% Last Modified by GUIDE v2.5 11-Jun-2015 00:16:19
...
ustalonaMaxIloscKas=str2num(get(handles.maxKas,'String'));
ustalonaMaxIloscKuchni=str2num(get(handles.maxKuchni,'String'));
...
maxKolejkaDoKasy=str2num(get(handles.max_kolKasa,'String'));
maxKolejkaDoKuchni=str2num(get(handles.max_kolKuch,'String'));
oczekiwanie=0;
oczekiwanieMax=ustalonaMaxIloscKas*ustalonaMaxIloscKuchni;
...
%koniec danych do wykresow
for maxiloscKas=1:ustalonaMaxIloscKas
    for maxiloscKuchni=1:ustalonaMaxIloscKuchni
        ...
        while(dni<dlSym)
            ...
            while (godzina<godzinaStop)
                ...
                elseif((godzina>=8 && godzina<=10) || (godzina>=21))
                ...
                while (minuty<60)
                    ...
                    while (sekundy<60)
                        ...
                        if (kolejkaDoKuchni>maxKolejkaDoKuchni)
                            for i=1:maxiloscKuchni
                        ...
                        %i ludzi
                        if (kolejkaDoKasy>maxKolejkaDoKasy)
                            for i=1:maxiloscKas
...
set(handles.wynikSredniCzas, 'String', num2str(((dlSym*14)/przygotowanePosilki)*60*60,5));
...
function max_kolKasa_Callback(hObject, eventdata, handles)
% hObject    handle to max_kolKasa (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of max_kolKasa as text
%        str2double(get(hObject,'String')) returns contents of max_kolKasa as a double


% --- Executes during object creation, after setting all properties.
function max_kolKasa_CreateFcn(hObject, eventdata, handles)
% hObject    handle to max_kolKasa (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function max_kolKuch_Callback(hObject, eventdata, handles)
% hObject    handle to max_kolKuch (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of max_kolKuch as text
%        str2double(get(hObject,'String')) returns contents of max_kolKuch as a double


% --- Executes during object creation, after setting all properties.
function max_kolKuch_CreateFcn(hObject, eventdata, handles)
% hObject    handle to max_kolKuch (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
